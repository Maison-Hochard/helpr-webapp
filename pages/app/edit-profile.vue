    ...
    <div class="bg-secondary px-4 py-5 shadow sm:rounded-lg sm:p-6">
      <div class="md:grid md:grid-cols-3 md:gap-6">
        ...
        <div class="mt-5 space-y-6 md:col-span-2 md:mt-0">
          ...
          <div>
            <label for="about" class="block text-sm font-medium text-muted"
              >Bio</label
            >
            <div class="mt-1">
              <textarea
          ...
          <div>
            ...
            >
            <div
              class="mt-1 flex justify-center rounded-md border-2 border-dashed border-gray-600 px-6 pt-5 pb-6"
            >
            ...
            <div class="flex justify-end mt-5">
              ...
              <button
                type="submit"
                class="bg-accent rounded-md px-5 ml-4 hover:bg-accent-hover"
              >
                Save
              </button>
            </div>
    ...
    <div class="bg-secondary shadow sm:rounded-lg">
      <div class="px-4 py-5 sm:p-6">
        ...
        <div class="my-2 max-w-xl text-sm text-muted">
          <p>
            You can manage your subscription here. If you cancel your
            subscription, you will lose access to all premium features.
          </p>
        </div>
        <div>
          <div
          ...
          <div
            v-if="
              user.Subscription.length > 0 &&
              user.Subscription &&
              user.Subscription[0].name === 'Trial'
            "
          >
    ...
    <div class="bg-secondary shadow sm:rounded-lg">
      <div class="px-4 py-5 sm:p-6">
        ...
        <div class="mt-5">
          <button
            type="button"
            class="bg-red-600 text-inverted px-4 py-2 rounded-md sm:text-sm"
            @click="deleteAccount"
          >
            Delete account
          </button>
